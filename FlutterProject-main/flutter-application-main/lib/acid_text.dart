...
class acid_text extends StatefulWidget {
  const acid_text({Key? key}) : super(key: key);

  @override
  State<acid_text> createState() => _acid_textState();
}

class _acid_textState extends State<acid_text> {
  @override
